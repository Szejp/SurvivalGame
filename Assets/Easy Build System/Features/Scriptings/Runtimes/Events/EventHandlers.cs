...
namespace EasyBuildSystem.Runtimes.Events
{
    public class EventHandlers
    {
        ...
        public delegate void EventHandlerAffectedPhysicsPart(PartBehaviour part);

        public static event EventHandlerAffectedPhysicsPart OnAffectedPart;

        /// <summary>
        /// This method is called when a part is removed.
        /// </summary>
        public static void AffectedPart(PartBehaviour part)
        {
            if (OnAffectedPart != null)
                OnAffectedPart.Invoke(part);
        }
        ...
        public delegate void EventHandlerSocketChangedState(SocketBehaviour socket, OccupancyType occupancy);

        public static event EventHandlerSocketChangedState OnSocketChangedState;
        ...
        public delegate void EventHandlerStorageLoadingDone(PartBehaviour[] Parts, GroupBehaviour group);
