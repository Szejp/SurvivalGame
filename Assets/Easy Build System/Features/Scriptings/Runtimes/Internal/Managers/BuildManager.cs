...
namespace EasyBuildSystem.Runtimes.Internal.Managers
{
    ...
    public class BuildManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// This method allows to place a part for network.
        /// </summary>
        public void PlacePrefabForNetwork(PartBehaviour part, Vector3 position, Vector3 rotation, Vector3 scale)
        {
            part.transform.position = position;
            part.transform.rotation = Quaternion.Euler(rotation);
            part.transform.localScale = scale;

            EventHandlers.PlacedPart(part, null);
        }
