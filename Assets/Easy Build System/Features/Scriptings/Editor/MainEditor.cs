    ...
    public class MainEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            try
            {
                ...
                GUILayout.BeginArea(new Rect(1, -14, Window.maxSize.x - 1, Screen.height + 14), "", "window");
                ...
                if (NavigationIndex == 0)
                {
                    ...
                    if (GUILayout.Button("Asset Store Link..."))
                    ...
                    if (GUILayout.Button("Documentation Link..."))
                ...
                if (NavigationIndex == 1)
                {
                    ...
                    AddIntegration("(Exit Games) Photon Network here the list of (PUN1)", "/content/1786", "EXITGAMESV1", "", null, null);
