    ...
    public class PartBehaviourInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (BasePartFoldout)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("AvoidAnchoredOnSocket"), new GUIContent("Avoid Anchored On Socket(s) :", "This allows to avoid the clipping on the socket(s) which contains this part in offsets list."));

                EditorGUILayout.PropertyField(serializedObject.FindProperty("AvoidDestruction"), new GUIContent("Avoid Destruction :", "This allows to avoid the destruction of the part during the destruction mode."));
            }
