...
{
    [CustomEditor(typeof(DesktopBuilderBehaviour), true)]
    public class DesktopBuilderBehaviourEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical("Easy Build System - Desktop Builder Behaviour", "window", GUILayout.Height(10));
            ...
            GUILayout.Label("Desktop Builder Behaviour Settings", EditorStyles.largeLabel);
            ...
            if (Help)
            {
                EditorGUILayout.HelpBox("This component contains all the behaviours whose can be executed by the player during the runtime on desktop.\n" +
            ...
            GUILayout.Label("Builder Inputs Settings", EditorStyles.largeLabel);
            ...
            if (InputsFoldout)
            {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("PlacementModeKey"), new GUIContent("Placement Mode Key :", "This allows to define input used to switch in placement mode."));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("DestructionModeKey"), new GUIContent("Destruction Mode Key :", "This allows to define input used to switch in destruction mode."));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("EditionModeKey"), new GUIContent("Edition Mode Key :", "This allows to define input used to switch in edition mode."));

                EditorGUILayout.PropertyField(serializedObject.FindProperty("ValidateModeKey"), new GUIContent("Validate Action Key :", "This allows to define input used to validate action in the current mode."));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("CancelModeKey"), new GUIContent("Cancel Action Key :", "This allows to define input used to cancel action in the current mode."));
            }
